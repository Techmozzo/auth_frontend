...
const CustomCheckbox = ({ handleChecked, name, checked }) => {
  const uniqueValue = uuid();
  return (
    <div className="form-group">
      <label className="checkbox" htmlFor={uniqueValue} aria-label="checkbox">
        <input type="checkbox" id={uniqueValue} name={name} onChange={handleChecked} checked={checked} />
